#!/bin/sh
#$ -S /bin/sh
#Version1.0	user@example.com	2022-03-31
echo Start Time : 
date
##  The real data comes from GCA_000146045 and GCA_000977955 [ see run2.sh]

##         minimap2  paf file  Format to Link File    ####
perl  ../../bin/GetTwoGenomeSyn.pl  Paf2Link   ../RealData/Yeast/SAMPLE.paf     5000  ../RealData/Yeast/SAMPLE.link
../../bin/NGenomeSyn	-InConf	in1.conf	-OutPut	Minimap2


###    MCScanX collinearity file Format to Link File    ####
perl  ../../bin/MCScanX2Link.pl   ../RealData/Yeast/GCA_000146045.2_R64_genomic.gff.gz ../RealData/Yeast/GCA_000977955.2_Sc_YJM1447_v1_genomic.gff.gz     ../RealData/Yeast/SAMPLE.collinearity     OUT2
mv    OUT2.A2B.link   ../RealData/Yeast/SAMPLE.link
